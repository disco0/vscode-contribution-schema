...
//#region Configuration Setting Scope
...
export type Keys<T extends { [key: string]: string }> = keyof T

export type ConfigurationSettingScope = Keys<typeof ConfigurationSettingScopes>;

//#endregion Configuration Setting Scope
...
export declare type ConfigurationSchema = JSONSchema & {
     ...
     */
    properties?: {[key: string]: ConfigurationSettingSchema}
}
